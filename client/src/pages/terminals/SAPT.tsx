...
const SAPT: React.FC = () => {
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      >
        <div className="bg-gradient-to-r from-violet-600 to-purple-600 rounded-2xl shadow-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
