            ...
            {/* <div className="relative z-10 mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  ...
                  <a
                    href="https://calendly.com/bakhs-group"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center bg-[#1D4ED8] text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:bg-[#2563EB] transition duration-300"
                  >
                    Schedule Now
                    <ExternalLink className="w-4 h-4 ml-2" />
                  </a>
