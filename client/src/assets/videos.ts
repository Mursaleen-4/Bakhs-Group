// HD Videos for HeroCarousel - Shipping containers in seas only
// HD Videos for HeroCarousel - Shipping containers in seas only
export const carouselVideos = [
  {
    video: '/videos/1.mp4', // Local file in public/videos folder
    fallback: '',
    description: 'Large container ship navigating through ocean waters'
  },
  {
    video: '/videos/2.mp4', // Local file in public/videos folder
    fallback: '',
    description: 'Aerial view of container ship with colorful containers'
  },
  {
    video: '/videos/3.mp4', // Local file in public/videos folder
    fallback: '',
    description: 'Massive cargo ship loaded with containers at sea'
  }
];
